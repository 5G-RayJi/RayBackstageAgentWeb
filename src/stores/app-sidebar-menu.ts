    ...
    return [
      ...
      { url: "/gallery", icon: "fa fa-image", title: "Gallery" },
      {
        ...
        children: [
          ...
          {
            url: "/page-option/with-fixed-footer",
            title: "Page with Fixed Footer",
            highlight: true,
          },
          {
            url: "/page-option/without-sidebar",
            title: "Page without Sidebar",
          },
          {
            url: "/page-option/with-right-sidebar",
            title: "Page with Right Sidebar",
          },
          {
            url: "/page-option/with-minified-sidebar",
            title: "Page with Minified Sidebar",
          },
          {
            url: "/page-option/with-two-sidebar",
            title: "Page with Two Sidebar",
          },
          { url: "/page-option/full-height", title: "Full Height Content" },
          {
            url: "/page-option/with-wide-sidebar",
            title: "Page with Wide Sidebar",
          },
          {
            url: "/page-option/with-light-sidebar",
          ...
          {
            url: "/page-option/with-boxed-layout",
            title: "Page with Boxed Layout",
          },
          {
            url: "/page-option/with-mixed-menu",
          ...
          {
            url: "/page-option/with-transparent-sidebar",
            title: "Page with Transparent Sidebar",
          },
          {
            url: "/page-option/with-search-sidebar",
            title: "Page with Search Sidebar",
            highlight: true,
          },
          {
            url: "/page-option/with-hover-sidebar",
      ...
      },
      {
        ...
        icon: "fa fa-medkit",
        title: "Helper",
        children: [{ url: "/helper/css", title: "Predefined CSS Classes" }],
      },
      {
        url: "/menu",
        ...
        children: [
          {
            ...
            children: [
              {
                url: "/menu/menu-1-1/menu-2-1",
                title: "Menu 2.1",
                children: [
                  {
                    url: "/menu/menu-1-1/menu-2-1/menu-3-1",
                    title: "Menu 3.1",
                  },
                  {
                    url: "/menu/menu-1-1/menu-2-1/menu-3-2",
                    title: "Menu 3.2",
                  },
                ],
              },

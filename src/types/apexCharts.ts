...
export interface XAxis {
  ...
  /**X軸標籤資料 */
  categories: string[];
  /**X軸間隔點(type='numeric'時,可以特別使用'dataPoints') */
  tickAmount: number | string;
  /**標籤方式 */
  tickPlacement: number | string;
  /**標籤方式 */
  min: number | string;
}
...
export type ApexMarkerShape = MarkerShapeOptions | MarkerShapeOptions[];
